---
title: Docker 启动顺序控制
date: 2017-04-19 15:28:24
url: docker_start_order
categories: docker
tags: 
	- docker
	- 启动顺序
...
3. 那么你tomcat镜像的启动脚本就要这么写：
```ps
$docker run [OPTIONS] IMAGE[:TAG] wait-for-it.sh db:3306 -t 0 -q -s  /usr/local/tomcat/bin/catalina.sh run
```
