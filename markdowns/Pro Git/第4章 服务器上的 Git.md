...
![img](http://iissnan.com/progit/book_src/figures/18333fig0401-tn.png)
...
本节作为Gitolite的一个快速指南，指导基本的安装和设置。不能完全替代随Gitolite自带的大量文档。而且可能会随时改变本节内容，因此你也许想看看最新的[版本](http://sitaramc.github.com/gitolite/progit.html)。
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0402-tn.png)
图 4-2. GitHub 服务简介页面

选择一个系统中尚未使用的用户名，提供一个与之相关联的电邮地址，并输入密码（见图 4-3）：

![img](http://iissnan.com/progit/book_src/figures/18333fig0403-tn.png)
图 4-3. GitHub 用户注册表单
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0404-tn.png)
图 4-4. GitHub 的用户面板
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0408-tn.png)
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0409-tn.png)
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0410-tn.png)
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0411-tn.png)
图 4-11. 为项目添加协作者

添加完协作者之后，就可以在 Repository Collaborators 区域看到他们的名单（见图 4-12）：

![img](http://iissnan.com/progit/book_src/figures/18333fig0412-tn.png)
图 4-12. 项目协作者名单
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0413-tn.png)
...
![img](http://iissnan.com/progit/book_src/figures/18333fig0414-tn.png)
图 4-14. 点击 "fork" 按钮获得任意项目的可写副本

几秒钟之后，你将进入新建的项目页面，会显示该项目派生自哪一个项目（见图 4-15）：

![img](http://iissnan.com/progit/book_src/figures/18333fig0415-tn.png)
图 4-15. 派生后得到的项目副本
